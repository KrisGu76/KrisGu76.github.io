...
const EDU = {
  master: {
    school:  { zh: '研究生院校',   en: 'Graduate University' },
  ...
  bachelor: {
    school:  { zh: '本科院校',    en: 'Undergraduate University' },
    major:   { zh: '专业',        en: 'Major' },
...
// ── Skills data ─────────────────────────────────────────────────────────
const SKILLS_ZH = [
  { topic: '技能类别1', body: '请在此填写技能描述。' },
];
const SKILLS_EN = [
  { topic: 'Skill Category 1', body: 'Please fill in your skill description here.' },
];
